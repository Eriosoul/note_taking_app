...
def add_note():
    ...
    content_entry.grid(row=1, column=1, padx=10, pady=10)  # Corrected 'coumn' to 'column'

    def save_note():
        title = title_entry.get()  # Get the title from the entry widget
...
delete_button = ttk.Button(root, text='Delete',
                           command=delete_notes, style='primary.TButton')  # Added 'command=' before 'delete_notes'
